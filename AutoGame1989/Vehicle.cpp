...
{   
    ...
    DebugPushTestLine(m_car.q.position, m_car.headingVec, 4.0, 1.0, DirectX::Colors::Yellow);
    ...
    DebugPushTestLine(m_car.q.position, m_car.headingVec, 4.0, 1.0, DirectX::Colors::Red);
}
