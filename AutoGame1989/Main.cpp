...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    HDEVNOTIFY hNewAudio = nullptr;
    {
        ...
        wcex.lpszClassName = L"AutoGame1989WindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"AutoGame1989WindowClass", L"AutoGame1989", WS_OVERLAPPEDWINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, nullptr, nullptr, hInstance,
            nullptr);
        // TODO: Change to CreateWindowExW(WS_EX_TOPMOST, L"AutoGame1989WindowClass", L"AutoGame1989", WS_POPUP,
